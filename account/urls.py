...
urlpatterns = [
    ...
    path("validate-login-otp", auth.OTPLoginAPIView.as_view(), name='validate-login-otp'),
    path("logout", auth.LogoutAPIView.as_view(), name='logout'),
    path("forgot-password", auth.ForgotPasswordAPIView.as_view(), name='forgot-password'),
    ...
    path("deactivate-2fa", auth.TwoFactorDeactivateAPIView.as_view(), name='deactivate-2fa'),
    ...
    path("change-user-password", auth.ChangeUserPasswordAPIView.as_view(), name='change-user-password'),
]
