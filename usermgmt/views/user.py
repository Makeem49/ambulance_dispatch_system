...
from usermgmt.serializers.user import UserCreateSerializer, UserListSerializer, UserUpdateSerializer, UserDetailSerializer, UserPartialUpdateSerializer, UserSearchAndFilterSerializer, DeleteUserSerializer
...
class BaseUserAPIView(BaseAPIView):
    ...
    def get_service(self, *args, **kwargs):
        return ServiceFactory(UserManager, self.get_serializer_class(request=kwargs.get('request')))
