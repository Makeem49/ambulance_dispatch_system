...
from ambulance_mgmt.serializers.ambulance import AmbulanceCreateSerializer, AmbulanceListSerializer, AmbulanceUpdateSerializer, AmbulanceDetailSerializer, AmbulancePartialUpdateSerializer
...
class BaseAmbulanceAPIView(BaseAPIView):
    ...
    def get_service(self, *args, **kwargs):
        ...
        return ServiceFactory(AmbulanceManager, self.get_serializer_class(request=request))
